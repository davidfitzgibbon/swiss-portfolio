        ...
        {items.map((item, index) => (
          <li key={index} className="mt-4">
            <Link
              ...
              className="flex justify-between items-center transition-border border-transparent duration-200 border-t border-b hover:border-red py-4 group overflow-hidden"
            >
              <svg
                viewBox="0 0 70 100"
                className="transition-transform duration-200 w-[1em] h-[1.5em] block translate-x-[-50%]  group-hover:translate-x-[0%]"
              >
                <path
